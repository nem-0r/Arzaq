...
class UserCreate(UserBase):
    ...
    def validate_restaurant_name(cls, v, values):
        """Ensure restaurant name is provided for restaurants"""
        if values.get("role") == "restaurant" and not v:
            raise ValueError("Restaurant name is required for restaurant registration")
        return v
...
class SupabaseAuthRequest(BaseModel):
    ...
    def validate_restaurant_name(cls, v, values):
        """Ensure restaurant name is provided for restaurants"""
        if values.get("role") == "restaurant" and not v:
            raise ValueError("Restaurant name is required for restaurant role")
        return v
