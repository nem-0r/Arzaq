...
async def get_optional_current_user(
    ...
    Usage:
        @app.get("/posts")
        def get_posts(current_user = Depends(get_optional_current_user)):
...
async def get_current_restaurant(current_user = Depends(get_current_user)):
    """
    Get current user and verify they are a restaurant (approved or pending)

    Usage:
        @app.get("/restaurant-profile")
        def restaurant_profile(current_user = Depends(get_current_restaurant)):
            # Any restaurant (approved or pending) can access this
    """
