...
class User(Base):
    ...
    # PayBox integration (optional - if not set, uses default from settings)
    paybox_merchant_id = Column(String(255), nullable=True)
    paybox_secret_key = Column(String(255), nullable=True)
