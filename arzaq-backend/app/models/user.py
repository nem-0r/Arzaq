...
class User(Base):
    ...
    restaurant_name = Column(String(255), nullable=True)  # Restaurant business name
    ...
    impact = relationship("UserImpact", back_populates="user", uselist=False, cascade="all, delete-orphan")
    posts = relationship("Post", foreign_keys="Post.user_id", back_populates="author", cascade="all, delete-orphan")
