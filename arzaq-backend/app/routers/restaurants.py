...
async def approve_restaurant(
    ...
    notification = Notification(
        ...
        message=f"Congratulations! Your restaurant '{restaurant.restaurant_name or restaurant.full_name}' has been approved. You can now start adding food items.",
...
async def reject_restaurant(
    restaurant_id: int,
    reason: str = "Your application does not meet our requirements",
    current_user: User = Depends(get_current_admin),
    db: Session = Depends(get_db)
):
    """
    ...
    notification = Notification(
        ...
        message=f"Unfortunately, your restaurant application has been rejected. Reason: {reason}",
        related_id=restaurant.id,
        related_type="restaurant"
    )
    db.add(notification)
