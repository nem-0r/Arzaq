...
from app.core.security import get_current_user, get_current_admin, get_current_active_restaurant
...
async def get_my_restaurant(
    ...
    - Requires active restaurant role
    - Returns own restaurant details
    """
    return current_user
